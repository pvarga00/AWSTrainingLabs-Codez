...
// Publish this code from the command line (CLI: CMD or PS) using this command set: "dotnet lambda deploy-function DotnetCalculator"
        ...
        public async Task<string> FunctionHandler(S3Event evnt, ILambdaContext context)
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(responseStream))
                {
                    ...
                    if (numbers.Length > 0)
                    {
                        // caclulate min/max/average/count
                        var min = numbers.Min();
                        var max = numbers.Max();
            ...
            records.Add(
                new S3EventNotification.S3EventNotificationRecord
                {
                    S3 = new S3EventNotification.S3Entity
                    {
                        ...
                        Bucket = new S3EventNotification.S3BucketEntity { Name = "calculator-input-pjv" },
