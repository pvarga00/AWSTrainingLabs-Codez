...
namespace Lab3
{
    // The InfectionStatistics class queries the infections table and reports the
    // total number of infections in a city
    public static class InfectionStatistics
    {
        public static readonly string InfectionsTableName = InfectionsTableCreator.InfectionsTableName;
        public static readonly string CityDateIndexName = InfectionsTableCreator.CityDateIndexName;
        ...
        public static int QueryByCity(string inputCity)
        {
            ...
            Debug.WriteLine("-------------------------------------------------------------");
            Debug.WriteLine("Summary: Number of infections in {0} city is {1}", inputCity, itemCount);
            return itemCount;
        }
